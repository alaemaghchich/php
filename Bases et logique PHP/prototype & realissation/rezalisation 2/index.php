...
<style>
body { font-family: Arial; background-color: #eef2f7; padding: 30px; }
h2 { color: #2c3e50; }
a { text-decoration: none; color: white; background-color: #3498db; padding: 8px 12px; border-radius: 4px; margin-right: 5px; }
a:hover { background-color: #2980b9; }
.card { background-color: white; padding: 20px; margin-bottom: 15px; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.1); border-left: 6px solid #3498db; }
.alert { margin-top: 8px; padding: 6px; border-radius: 4px; font-weight: bold; }
.alert-danger { background-color: #ffe6e6; color: #c0392b; }
.badge { display: inline-block; padding: 4px 8px; margin: 3px; background-color: #dff0ff; color: #2980b9; border-radius: 20px; font-size: 12px; }
</style>
</head>
<body>
...
if ($c["imc"]<18.5 || $c["imc"]>=30) echo "<div class='alert alert-danger'>⚠ Abnormal BMI</div>";
?>
